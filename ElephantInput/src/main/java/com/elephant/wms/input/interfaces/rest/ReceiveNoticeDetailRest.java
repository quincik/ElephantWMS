...
@RestController
@RequestMapping("/receive/notice/detail")
public class ReceiveNoticeDetailRest extends BasicRest {
    ...
    public Result<Boolean> create(@RequestBody Map<String, Object> param){
        ...
        Result<Boolean> result = (Result<Boolean>)
                producerTemplate.requestBody("direct:createReceiveNoticeDetail", param);
        return result;
    }
}
